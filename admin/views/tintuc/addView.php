<div class="col-md-12" style="margin-top: 50px;">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<form action="index.php?controller=tintuc/add&act=add" method="post" enctype="multipart/form-data">
				<table cellpadding="3" style="width: 100%">
					<tr>
						<td width="10%">Tên bài viết</td>
						<td width="90%"><input type="text" name="name" placeholder="Tên bài viết" class="form-control" required></td>
					</tr>
					<tr>
						<td>Ảnh</td>
						<td><input type="file" name="image" style="padding-top: 10px;"></td>
					</tr>
				...
				<a href="index.php?controller=tintuc/list" class="btn btn-success" style="margin-top: 10px;">Quay lại</a>
			</form>
		</div>
	</div>
</div>