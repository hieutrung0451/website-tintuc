<div class="col-md-6 col-md-offset-3" style="margin-top: 50px; margin-bottom: 100px;">
	<div class="panel panel-primary">
		<div class="panel-heading">Cập nhập chủ đề</div>
		<div class="panel-body">
			<form action="index.php?controller=catalog_tintuc/edit&id=<?php echo $value["id"]?>&act=edit" method="post">
				...
				<a href="index.php?controller=catalog_tintuc/list" class="btn btn-success">Quay lại</a>
			</form>
		</div>
	</div>
</div>